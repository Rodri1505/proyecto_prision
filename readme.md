# Sistema de Gestión de Prisión  
Proyecto de la asignatura **Gestión de Bases de Datos** – 2º ASIR  

---

## 1. Descripción general

Este proyecto desarrolla una aplicación web dinámica basada en **Flask (Python)** y conectada a una base de datos **MySQL/MariaDB**.

El sistema permite gestionar la información principal de un centro penitenciario utilizando cinco tablas:
...
La aplicación realiza consultas SQL reales y muestra los resultados mediante plantillas HTML generadas con **Jinja2**.

---

## 2. Script SQL completo (CREATE + INSERTS)
